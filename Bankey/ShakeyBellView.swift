...
//  Bankey
//
//  Created by Koty Stannard on 1/9/22.
//
...
//MARK: - UIView Setup/Style/Layout
extension ShakeyBellView {
    ...
    func style() {
        ...
        let image = UIImage(systemName: "bell.fill")?.withTintColor(.white).withRenderingMode(.alwaysOriginal)
